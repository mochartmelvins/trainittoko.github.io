   ...
   <div class="container">
    ...
    <table class="table table-bordered">
     ...
     <tbody>
      ...
      <!-- menampilkan produk yang sedang diperulangakan berdasarkan id_produk -->
      <?php
      ...
      <?php $nomor++; ?>
	   ...
	   <form method="post">
		   ...
		   <div class="row">
			   ...
			   <div class="col-md-4">
				   <div class ="form-group">
					   <input type="text" readonly value="<?php echo $_SESSION["pelanggan"]['telfon_pelanggan'] ?>" class="form-control">
				   </div>
			   </div>
			   <div class="col-md-4">
